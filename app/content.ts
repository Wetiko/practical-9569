...
export async function loadReference(id:string){const load=references[`./references/${id}.json`];if(!load)throw Error('Unknown reference');return await load() as {solution:string;steps:{line:number;text:string}[]}}
