...
export default function Discover({onBrowse,onTopic,onResume,onExam,title,solved,count,examDate,onExamDate,motionPaused}:{onBrowse:()=>void;onTopic:(topic:string)=>void;onResume:()=>void;onExam:()=>void;title:string;solved:number;count:number;examDate:string;onExamDate:(date:string)=>void;motionPaused:boolean}){
